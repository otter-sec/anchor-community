...
Check data generation script at [../scripts/validator-bonds-client-generator](validator-bonds-client-generator)
to push account data to the testing environment on-the-fly.
