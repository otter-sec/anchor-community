...
use rbac_utils::{constants::ASSET_CONTROLLER_ID, THAW_TOKEN_ACCOUNT_IX};
...
pub fn handler(ctx: Context<ThawTokenAccount>, cpi_data: Vec<u8>) -> Result<()> {
    ...
    require!(
        cpi_data.starts_with(&THAW_TOKEN_ACCOUNT_IX),
