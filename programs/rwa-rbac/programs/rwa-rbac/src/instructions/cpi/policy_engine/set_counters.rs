...
use rbac_utils::{constants::POLICY_ENGINE_ID, SET_COUNTERS_IX};
...
pub fn handler(ctx: Context<SetCounters>, cpi_data: Vec<u8>) -> Result<()> {
    ...
    require!(
        cpi_data.starts_with(&SET_COUNTERS_IX),
